...
class Book(models.Model):
    ...
    book_name = models.CharField(db_column='Book_Name', max_length=200)  # Field name made lowercase.
...
class MyBooks(models.Model):
    repayment_policy = models.CharField(db_column='Repayment_Policy', max_length=1000)  # Field name made lowercase.
...
class User(models.Model):
    ...
    email_address = models.CharField(db_column='Email_Address', max_length=30)  # Field name made lowercase.
    house_number = models.CharField(db_column='House_Number', max_length=10, blank=True, null=True)  # Field name made lowercase.
    street = models.CharField(db_column='Street', max_length=20)  # Field name made lowercase.
    locality = models.CharField(db_column='Locality', max_length=30)  # Field name made lowercase.
